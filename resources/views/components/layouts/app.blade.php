...
<html lang="en">
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{asset('assets/theam/img/icons/icon-72x72.png')}}">
    <!-- Apple Touch Icon -->
    <link rel="apple-touch-icon" href="{{asset('assets/theam/img/icons/icon-96x96.png')}}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{asset('assets/theam/img/icons/icon-152x152.png')}}">
    <link rel="apple-touch-icon" sizes="167x167" href="{{asset('assets/theam/img/icons/icon-167x167.png')}}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{asset('assets/theam/img/icons/icon-180x180.png')}}">
    <!-- CSS Libraries -->
